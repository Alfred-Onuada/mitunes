<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($send) {
            ...
            $redcheck = "SELECT * FROM notification WHERE userid = '$userid' ORDER BY id DESC";
            ...
            if ($rednr < 1) {
                ...
                ';
                                    ...
                                    } else if ($baseupload != 'Nil' && $type == 'album') {
                ...
                echo '       
                        ...
                        <div class="col s1">
                            <span onclick="delNot('.$reddata['id'].', '.$userid.')" class="del_not material-icons-round">clear</span>
                        </div>
                ...
                echo '
                    ...
                    <div onclick="clear_all_not('.$userid.')" class="clear_all_notification">
